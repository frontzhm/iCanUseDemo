~ function() {
  function Banner(banner, jsonData, delay) {
    // 全局变量变成私有属性
    this.banner = banner;
    // 0
    this.slidelist = utils.getElementsByClassName("slidelist", this.banner)[0];
    this.tiplist = utils.getElementsByClassName("tiplist", this.banner)[0];
    this.arrleft = utils.getElementsByClassName("arrleft", this.banner)[0];
    this.arrright = utils.getElementsByClassName("arrright", this.banner)[0];
